...
var ConvertTxStr string = "Convert Transaction"
var CommitTxStr string = "Commit Transaction"
...
func (tx *Transaction) GetTxCodeStr() string {
	if tx.Code() == PublicTx {
		...
		return RefundTxStr
	} else if tx.Code() == DepositsgTx {
		return DepositsgTxStr
	} else {
