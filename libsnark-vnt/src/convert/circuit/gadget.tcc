 ...
 ************************************************************************
 * sha256_two_block_gadget,  note_gadget_with_sub_and_comparison
 ************************************************************************
 * sha256(data+padding), 512bits < data.size() < 1024-64-1bits
 * **********************************************************************
 * publicData: cmt_old, sn_old, cmt_S, sn_old, cmt 
 * privateData: value_old, r_old, value_s, sn_s, r_s, value, sn, r
 * **********************************************************************
...
public:
    ...
    // sub_and_comparison_gadget
    std::shared_ptr<note_gadget_with_sub_and_comparison<FieldT>> Sub_Cmp;
    ...
    convert_gadget(
        ...
        Sub_Cmp.reset(new note_gadget_with_sub_and_comparison<FieldT>(
            pb,
            value_old, 
            sn_old, 
            r_old, 
    ...
    void generate_r1cs_constraints() { 
        ...
        Sub_Cmp->generate_r1cs_constraints();
    ...
    void generate_r1cs_witness(
        ...
        Sub_Cmp->generate_r1cs_witness(note_old, note_s, note);
